...
London-based **Data Scientist and Python Developer**, formally trained through **Imperial College London** (96% average). I work across the full data workflow — from raw data through to deployed model — building clean, well-documented solutions grounded in statistical rigour.

Alongside data science, I independently design, build, and ship — Android apps, trader tools, generative art systems, live wallpapers, screensavers, interactive maps, and word-cloud typography. Thirty-four projects across the **Google Play Store**, **Gumroad**, **Lemon Squeezy**, and **Envato**. This side of my work has sharpened real product instincts: pricing, positioning, knowing when to ship and when to keep going — those lessons sit alongside the code.

I'm available for **freelance and contract work**, open to collaboration, and actively seeking a data or Python development role.
...
**Languages & Data**
`Python` `Dart / Flutter` `Kotlin & Java` `JavaScript` `HTML & CSS` `SVG` `SQL` `Machine Learning` `NLP & spaCy` `pandas & NumPy` `scikit-learn` `TensorFlow`

**Frameworks & Tools**
`FastAPI` `Plotly Dash` `React` `Flask` `Electron` `Streamlit` `Node.js` `Firebase` `Docker` `Git & GitHub` `REST APIs` `Jupyter` `Matplotlib & Seaborn` `Vanilla JS`
...
| 02 | [World Map](https://github.com/ShazMoghaddam/world-map) — Interactive choropleth map of 172 countries across 7 data layers, with custom data import and a JavaScript API | HTML, CSS, Vanilla JS, SVG |
| 03 | [SalaryAxis](https://github.com/ShazMoghaddam/salaryaxis) — UK salary intelligence platform built on ONS open data | Python, Flask, React, pandas, NumPy, SciPy, Docker, AWS / GCP |
| 04 | [CVLens](https://github.com/ShazMoghaddam/CVLens) — NLP-powered CV parser, section detector, and quality feedback engine | Python, spaCy, PyMuPDF, python-docx, regex |
| 05 | [Aero Atlas Screensaver](https://github.com/ShazMoghaddam/aero-atlas-screensaver) — Split-flap world clock screensaver for macOS and Windows | Electron, HTML, CSS, JS |
| 06 | [Typography Digits](https://github.com/ShazMoghaddam/typography-digits) — Generative word-cloud art where 0–9 are built from programming vocabulary | HTML, Canvas, SVG, Vanilla JS |
| 07 | [KNOK Matrix / Mono](https://github.com/ShazMoghaddam/KNOK-Matrix-Mono-font) — Geometric SVG typographic system and live digital clock | HTML, CSS, SVG, Vanilla JS |
| 08 | [TradeHours Pro](https://github.com/ShazMoghaddam/tradehours-pro) — Live global market hours tracker with holiday calendar and PWA support | HTML, CSS, Vanilla JS |
| 09 | [Market Pulse](https://github.com/ShazMoghaddam/Market-Pulse-Minimal-Economic-Calendar-for-Traders) — Minimal economic calendar for traders with live event status and countdowns | HTML, CSS, Vanilla JS |
| 10 | [SearchWars](https://github.com/ShazMoghaddam/searchwars) — Flutter mobile game: guess which of two things gets more Google searches | Dart, Flutter, Firebase |
| 11 | [FIFA World Cup 2026 Predictor](https://github.com/ShazMoghaddam/wc2026) — Interactive bracket predictor with 188-question trivia quiz and PNG export | HTML, CSS, Vanilla JS |
| 12 | [Lending Club Loan Project](https://github.com/ShazMoghaddam/Lending_Club_Loan_Project) — Loan default prediction with logistic regression | Python, pandas, NumPy, scikit-learn |
